...
export function PlayerName({ player }: { player: Pick<PlayerView, "name" | "nickname" | "displayName" | "position" | "injuryDays" | "suspended" | "onLoan" | "onLoanOut" | "loanClubName" | "loanFromName"> }) {
