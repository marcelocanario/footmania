...
export function PlayerName({ player }: { player: Pick<PlayerView, "name" | "position" | "isStar" | "worldClass" | "injuryDays" | "suspended" | "onLoan" | "onLoanOut" | "loanClubName" | "loanFromName"> }) {
  return (
