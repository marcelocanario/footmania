...
-- DropForeignKey
ALTER TABLE "AdminSchedulerAudit" DROP CONSTRAINT "AdminSchedulerAudit_saveId_fkey";

-- DropForeignKey
ALTER TABLE "CareerRecord" DROP CONSTRAINT "CareerRecord_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Club" DROP CONSTRAINT "Club_ownerUserId_fkey";

-- DropForeignKey
ALTER TABLE "Club" DROP CONSTRAINT "Club_saveId_fkey";

-- DropForeignKey
ALTER TABLE "ClubEloEvent" DROP CONSTRAINT "ClubEloEvent_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Competition" DROP CONSTRAINT "Competition_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Competition" DROP CONSTRAINT "Competition_seasonId_fkey";

-- DropForeignKey
ALTER TABLE "DailyExecution" DROP CONSTRAINT "DailyExecution_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Fixture" DROP CONSTRAINT "Fixture_saveId_fkey";

-- DropForeignKey
ALTER TABLE "FreeAgentListing" DROP CONSTRAINT "FreeAgentListing_saveId_fkey";
...
-- DropForeignKey
ALTER TABLE "GameClock" DROP CONSTRAINT "GameClock_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Invitation" DROP CONSTRAINT "Invitation_inviterUserId_fkey";

-- DropForeignKey
ALTER TABLE "LedgerEntry" DROP CONSTRAINT "LedgerEntry_saveId_fkey";

-- DropForeignKey
ALTER TABLE "LiveMatch" DROP CONSTRAINT "LiveMatch_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Loan" DROP CONSTRAINT "Loan_saveId_fkey";

-- DropForeignKey
ALTER TABLE "MarketBid" DROP CONSTRAINT "MarketBid_saveId_fkey";

-- DropForeignKey
ALTER TABLE "MarketReservation" DROP CONSTRAINT "MarketReservation_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Match" DROP CONSTRAINT "Match_saveId_fkey";

-- DropForeignKey
ALTER TABLE "MatchEvent" DROP CONSTRAINT "MatchEvent_saveId_fkey";

-- DropForeignKey
ALTER TABLE "MatchStat" DROP CONSTRAINT "MatchStat_saveId_fkey";

-- DropForeignKey
ALTER TABLE "MpAllocation" DROP CONSTRAINT "MpAllocation_seasonId_fkey";

-- DropForeignKey
ALTER TABLE "MpClubSeason" DROP CONSTRAINT "MpClubSeason_seasonId_fkey";

-- DropForeignKey
ALTER TABLE "NewsItem" DROP CONSTRAINT "NewsItem_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Player" DROP CONSTRAINT "Player_saveId_fkey";

-- DropForeignKey
ALTER TABLE "PlayerMarketTransaction" DROP CONSTRAINT "PlayerMarketTransaction_saveId_fkey";

-- DropForeignKey
ALTER TABLE "PlayerSeasonHistory" DROP CONSTRAINT "PlayerSeasonHistory_saveId_fkey";
...
-- DropForeignKey
ALTER TABLE "ScheduledEvent" DROP CONSTRAINT "ScheduledEvent_saveId_fkey";

-- DropForeignKey
ALTER TABLE "SeasonAward" DROP CONSTRAINT "SeasonAward_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Session" DROP CONSTRAINT "Session_userId_fkey";

-- DropForeignKey
ALTER TABLE "StandingsRow" DROP CONSTRAINT "StandingsRow_saveId_fkey";

-- DropForeignKey
ALTER TABLE "TransferAuction" DROP CONSTRAINT "TransferAuction_saveId_fkey";

-- DropForeignKey
ALTER TABLE "Trophy" DROP CONSTRAINT "Trophy_saveId_fkey";
...
-- DropTable
DROP TABLE "AdminSchedulerAudit";

-- DropTable
DROP TABLE "CareerRecord";

-- DropTable
DROP TABLE "Club";

-- DropTable
DROP TABLE "ClubEloEvent";

-- DropTable
DROP TABLE "Competition";

-- DropTable
DROP TABLE "DailyExecution";

-- DropTable
DROP TABLE "Fixture";

-- DropTable
DROP TABLE "FreeAgentListing";

-- DropTable
DROP TABLE "Friendship";

-- DropTable
DROP TABLE "GameClock";
...
-- DropTable
DROP TABLE "MarketBid";

-- DropTable
DROP TABLE "MarketReservation";
...
-- DropTable
DROP TABLE "MpActivity";

-- DropTable
DROP TABLE "MpAllocation";

-- DropTable
DROP TABLE "MpAudit";

-- DropTable
DROP TABLE "MpClubSeason";

-- DropTable
DROP TABLE "MpMembership";
...
-- DropTable
DROP TABLE "PlayerMarketTransaction";

-- DropTable
DROP TABLE "PlayerSeasonHistory";
...
-- DropTable
DROP TABLE "StandingsRow";

-- DropTable
DROP TABLE "TransferAuction";

-- DropTable
DROP TABLE "Trophy";

-- email/identity exists on these rows and password login is being removed, so
-- Legacy username/password accounts (pre-Google). The game is pre-release: no
-- email/identity exists on these rows and password login is being removed, so
-- they are wiped instead of migrated. All FK-dependent tables (saves, clubs,
-- friendships, invitations, warnings, notifications, push subscriptions, mp
-- activity) are owned by these users and cascade with them.
